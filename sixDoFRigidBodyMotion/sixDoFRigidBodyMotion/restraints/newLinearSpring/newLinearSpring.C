...
{
    defineTypeNameAndDebug(newLinearSpring, 0);
...
Foam::sixDoFRigidBodyMotionRestraints::newLinearSpring::newLinearSpring
(
    const word& name,
...
void Foam::sixDoFRigidBodyMotionRestraints::newLinearSpring::restrain
(
...
bool Foam::sixDoFRigidBodyMotionRestraints::newLinearSpring::read
(
    const dictionary& sDoFRBMRDict
)
{
...
void Foam::sixDoFRigidBodyMotionRestraints::newLinearSpring::write
(
    Ostream& os
) const
{
